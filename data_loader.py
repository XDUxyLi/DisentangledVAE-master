...
class DATA_LOADER(object):
    ...
    def read_matdataset(self):
        ...
        # feature = np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/gcn_feature3.npy')
        # feature = np.hstack((np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/gcn_feature3.npy'), matcontent['features'].T))
        # feature = np.hstack((np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/features_minus_mean1.npy'), matcontent['features'].T))
        # feature = np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/features_minus_mean1.npy')
        # feature = np.hstack((np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/gcn_feature3.npy'), np.load('/home/xzhe/Projects/CADA-VAE-PyTorch-master/features_minus_mean1.npy')))

        label = matcontent['labels'].astype(int).squeeze() - 1

        path = self.datadir + 'att_splits.mat'
        # path = self.datadir + 'att_splits04.mat'
        matcontent = sio.loadmat(path)
        ...
        # ###
        # self.feature = torch.from_numpy(scaler.fit_transform(feature)).float().to(self.device)
        # self.label = torch.from_numpy(label).long().to(self.device)
        # self.train_loc = trainval_loc
...
# d = DATA_LOADER(dataset='CUB', aux_datasource='attributes')
